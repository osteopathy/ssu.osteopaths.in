...
<Form.Root schema={formSchema} {form} {options} let:config method="POST">
	<div class="rounded-md border p-4">
		<h2 class="mb-1 text-xl text-muted-foreground">Session</h2>
			...
			<Form.Item>
				...
				<Form.Select bind:selected={selected_duration}>
					<Form.SelectTrigger
						...
						placeholder="Select Total Time it takes to give one session"
					/>
					<Form.SelectContent>
				...
				<Form.Description>Total time it takes to give one session.</Form.Description>
				<Form.Validation />
			</Form.Item>
		</Form.Field>
