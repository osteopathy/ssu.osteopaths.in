...
const layer = Array.from({ length: 14 }, (_, i) => ({ [i]: `rgb(var(--layer-${i}) / <alpha-value>)` })).reduce((t, v) => ({ ...t, ...v }), {})
        ...
        addBase({
            ":root": {
                ...getCssVariableDeclarations(lightShade, "layer", {
                    ...
                    "--destructive": getRgbChannels(red['red5']),
                    "--destructive-foreground": getRgbChannels(red['red12']),
                }),
            ...
            ".dark": {
                ...
                "--secondary-foreground": "var(--layer-12)",
                "--accent": "var(--layer-2)",
                "--accent-foreground": "var(--layer-10)",
                "--ring": "var(--layer-12)",
            },
        });
    },
